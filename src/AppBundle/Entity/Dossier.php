...
class Dossier
{
    ...
    public static function getFileTypes()
    {
        return [
            ...
            'Rélévé de notes BAC/BT2',
            'Rélévé de notes BAC+1',
            'Rélévé de notes BAC+2',
            'Rélévé de notes BAC+3',
            'Rélévé de notes BAC+4',
            "Attestation d'admissibilité",
            "Lettre d'engagement 1",
            "Lettre d'engagement 2",
            "Lettre d'engagement 3",
            "Lettre d'engagement 4",
            "Lettre d'engagement 5",
            'Divers',
        ];
    }
